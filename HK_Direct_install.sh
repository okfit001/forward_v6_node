...
S=nyanpass bash <(curl -fLSs https://dl.nyafw.com/download/nyanpass-install.sh) rel_nodeclient "-t e82ae60d-da3e-465a-8dca-fcfc12c64b44 -u https://forward.nett.to"
