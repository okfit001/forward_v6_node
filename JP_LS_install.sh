...
vm.min_free_kbytes = 353894

net.core.default_qdisc = fq
net.core.netdev_max_backlog = 4000
net.core.rmem_max = 72028792
net.core.wmem_max = 72028792
...
net.ipv4.tcp_rmem = 8192 87380 72028792
net.ipv4.tcp_wmem = 8192 65536 72028792
...
net.ipv4.tcp_max_syn_backlog = 11093
...
S=nyanpass bash <(curl -fLSs https://dl.nyafw.com/download/nyanpass-install.sh) rel_nodeclient "-t f8dac8b5-a535-4607-9de8-98f010a7796c -u https://forward.nett.to"
